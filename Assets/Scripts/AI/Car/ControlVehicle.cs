...
public class ControlVehicle : MonoBehaviour
{
    ...
    [SerializeField]private WheelComponent[] wheels;
    ...
    void Awake()
    {
        ...
        AIVScript = transform.GetComponent<VehicleAI>();
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.transform.root.GetComponent<ControlVehicle>())
        {

            collision.transform.root.GetComponent<ControlVehicle>().slip2 = Mathf.Clamp(collision.relativeVelocity.magnitude, 0.0f, 10.0f);
    ...
    void OnCollisionStay(Collision collision)
    {
       ...
       if (collision.transform.root.GetComponent<ControlVehicle>())
            collision.transform.root.GetComponent<ControlVehicle>().slip2 = 2.0f;
